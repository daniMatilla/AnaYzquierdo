  ...
  @foreach ($usuarios as $usuario)
    <tr>
      ...
      <td>
        ...
        <div class="col s6">
          <form action="{{ route('bloquear-usuario',['id' => $usuario->id_usuario]) }}" method="post">
            ...
            <a id="bloquear-{{ $usuario->id_usuario }}" href="#!"
               class="teal-text btn-bloquear-usuario waves-effect waves-light">
        ...
        {{--ELIMINAR--}}
        <div class="col s6">
          <a id="{{ $usuario->id_usuario }}" href="#modal-alert-eliminar-{{ $usuario->id_usuario }}"
             class="teal-text waves-effect waves-light btn-eliminar">
